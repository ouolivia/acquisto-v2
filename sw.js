...
const CACHE = 'procure-easy-v26';
const ASSETS = ['./','index.html','styles.css?v=4','theme.css?v=3','reference.css?v=13','app.js?v=23','manifest.webmanifest','icon.svg','icon-180.png','icon-192.png','icon-512.png'];
