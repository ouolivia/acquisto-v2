...
const CACHE = 'procure-easy-v30';
const ASSETS = ['./','index.html','styles.css?v=4','theme.css?v=3','reference.css?v=15','app.js?v=27','manifest.webmanifest','icon.svg','icon-180.png','icon-192.png','icon-512.png'];
